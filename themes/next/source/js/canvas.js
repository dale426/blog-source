  ...
  function Line(t) {
    this.flag = t,
      ...
      "v" == t ? (this.a.y = 0,
        ...
        this.b.x = randomIntFromInterval(0, ch)) : "h" == t && (this.a.x = 0,
          this.b.x = cw,
      ...
      this.update = function () {
        "v" == this.flag ? (this.a.x += this.va,
          this.b.x += this.vb) : "h" == t && (this.a.y += this.va,
            this.b.y += this.vb),
          this.edges()
      }
      ,
      this.edges = function () {
        "v" == this.flag ? ((this.a.x < 0 || this.a.x > cw) && (this.va *= -1),
          (this.b.x < 0 || this.b.x > cw) && (this.vb *= -1)) : "h" == t && ((this.a.y < 0 || this.a.y > ch) && (this.va *= -1),
